...
_4 milestone · 10 item pianificati (4 open · 6 done)._
...
| id | Titolo | Priorità | Status |
|----|--------|----------|--------|
| `vscode-marketplace-secret` | Manca il secret VSCE_PAT: il publish si salta invece di pubblicare | medium | open |
